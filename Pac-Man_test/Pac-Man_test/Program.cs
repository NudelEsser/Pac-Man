...
namespace Pac_Man_test
{
    internal class Program
    {
        ...
        private static void MovePlayer(int[] player, int[] oldplayer, int level)
        {
            int special = 0;
            if (level == 2)
            {
        ...
        private static void MoveHunter(int[] player, int[] hunter, int[] hunter2, int[] hunter3, int[] hunter4, int level, Stopwatch hunterwatch, int[] oldhunter, int[] oldhunter2, int[] oldhunter3, int[] oldhunter4)
        {
            int special = 0;
            if (level == 2)
            {
    ...
    private static void MovePrey(int[] prey, int[] oldprey, Stopwatch stopwatch, int level)
    {
    ...
    private static int CheckCollision(int[] player, int[] prey, int[] oldprey, int[] hunter, int[] hunter2, int score, int[] isGameOver, int level, Stopwatch stopwatch, int[] hunter3, int[] hunter4)
    {
    ...
    private static int quitOrRestart()
    {
        Console.Clear();
    ...
    private static void Display(int[] player, int[] oldplayer, int[] prey, int[] oldprey, int[] hunter, int[] hunter2, int score, int level, int[] hunter3, int[] hunter4, int[] oldhunter, int[] oldhunter2, int[] oldhunter3, int[] oldhunter4)
    {
        Console.BackgroundColor = ConsoleColor.Black;
        Console.ForegroundColor = ConsoleColor.White;
        Console.SetCursorPosition(0, 0);
